    ...
    for (it = 0; it < nt; it++) {
        ...
        if (term != NULL && term (par, y)) return (it+1);
            ...
            {   
                ...
                y[4]=traj[it][4]*sigma;
                y[5]=traj[it][5]*sigma;
                float beta1=atanf(y[5]/y[4])+SF_PI;
                consideredPoint[0]=reflectionPoint[2]+y[3];  /* z */
                consideredPoint[1]=reflectionPoint[0]+y[4];  /* x */
                consideredPoint[2]=reflectionPoint[1]+y[5];  /* y */
                ...
                float T=(-d-(consideredPoint[1]*a+consideredPoint[2]*b+consideredPoint[0]*c))/(a*a+b*b+c*c);
                ...
                y[3] = symmetricPoint[0]-reflectionPoint[2];
                y[4] = symmetricPoint[1]-reflectionPoint[0];
                y[5] = symmetricPoint[2]-reflectionPoint[1];

                float betap=atanf(y[5]/y[4])+SF_PI;
                float beta2=beta1-2*(beta1-beta2);
